...
class denuncias extends SMG_Controller {
	 ...
	 */
	/*
	 * public function index(){ $this->basico('true'); }
	 */
	...
	public function index() {
		...
		/*
		 * Funcion interna para comparar la latitud @param double $p_punto1 @param double $p_punto2 @return integer
		 */
	 ...
	 * @param
	 *        	string p_datos un array con los datos cargados por el usuario a partir del formulario o movil.
	 * @return array
	 */
